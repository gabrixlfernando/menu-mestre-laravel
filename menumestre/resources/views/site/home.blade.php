            ...
            <div class="row">
              <div class="col-md-7 col-lg-6 ">
                <div class="detail-box">
                  ...
                  <p>
                    Doloremque, itaque aperiam facilis rerum, comodi, temporibus sapiente ad mollitia laborum quam quisquam esse erro unde. Tempora ex doloremque, labore, sunt repellat dolore, iste magni quos nihil ducimus libero ipsam.
                  </p>
                  <div class="btn-box">
                    <a href="" class="btn1">
                      Peça agora
            ...
            <div class="row">
              <div class="col-md-7 col-lg-6 ">
                <div class="detail-box">
                  ...
                  <p>
                    Doloremque, itaque aperiam facilis rerum, comodi, temporibus sapiente ad mollitia laborum quam quisquam esse erro unde. Tempora ex doloremque, labore, sunt repellat dolore, iste magni quos nihil ducimus libero ipsam.                    </p>
                  <div class="btn-box">
                    <a href="" class="btn1">
                      Peça agora
                    </a>
            ...
            <div>
              ...
              <div class="detail-box">
                <h5>
                  Pizza Deliciosa                  </h5>
                <p>
                  Veniam debitis quaerat officiis quasi cupiditate quo, quisquam velit, magnam voluptatem repellendus sed eaque                  </p>
                <div class="options">
                  <h6>
                    $20
                  </h6>
      ...
      <div class="col-md-6">
        <div class="detail-box">
          ...
          <p>
            ...
            de alguma forma, por meio de humor injetado ou palavras aleatórias que não parecem nem um pouco verossímeis. Se você
            usar uma passagem de Lorem Ipsum, você precisa ter certeza de que não há nada embaraçoso escondido
      ...
      <div class="owl-carousel client_owl-carousel">
        <div class="item">
          <div class="box">
            <div class="detail-box">
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incidente ut labore et dolore magna aliqua. Ut enim ad minim veniam                <h6>
                Moana Michell
              </h6>
              <p>
                magna aliqua
